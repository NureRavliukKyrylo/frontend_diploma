...
interface ShowJoinedFilterProps {
  value?: boolean;
  onChange: (value: boolean) => void;
}

export const ShowJoinedFilter = ({
  value,
  onChange,
}: ShowJoinedFilterProps) => (
  <div className={styles.joinedProject}>
    <h1 className={styles.titleFilterMoreOptions}>Display joined projects</h1>
    <Switch
      isSelected={value}
