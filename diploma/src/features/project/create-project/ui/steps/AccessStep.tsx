...
import type { ProjectPolicy } from "../../api/createProjectApi";
import styles from "./CreateProjectSteps.module.scss";

interface AccessStepProps {
  values: Pick<CreateProjectFormState, "joinPolicy" | "leavePolicy">;
  onChange: (field: "joinPolicy" | "leavePolicy", value: ProjectPolicy) => void;
}
