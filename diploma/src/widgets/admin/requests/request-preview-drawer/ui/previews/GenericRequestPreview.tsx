...
export const GenericRequestPreview = ({ request }: GenericRequestPreviewProps) => {
    ...
    <>
      <div className={styles.drawerDecisionCard}>
        ...
        <div>
          ...
          <strong>{requestTypeLabels[request.typeName]}</strong>
          <p>{request.description || "No description provided."}</p>
        </div>
      </div>

      <section className={styles.drawerSection}>
        <div className={styles.drawerSectionLabel}>Request context</div>
        <div className={styles.drawerInfoGrid}>
          <DrawerInfoRow label="Requester" value={request.userId} />
          <DrawerInfoRow
            label="Target"
