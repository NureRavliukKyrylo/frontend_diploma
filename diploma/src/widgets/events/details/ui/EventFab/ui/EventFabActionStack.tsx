...
import {
  ...
  itemVariants,
  menuVariants,
} from "../config/eventFabPresentation";
import type { useEventFabActions } from "../model/useEventFabActions";
import styles from "@widgets/organizations/details/ui/OrganizationFab/OrganizationFab.module.scss";

interface EventFabActionStackProps {
  event: Event;
  model: ReturnType<typeof useEventFabActions>;
}

export const EventFabActionStack = ({
  event,
  model,
}: EventFabActionStackProps) => {
        ...
        <>
          ...
          >
            ...
            <span className={styles.contextText}>
              ...
              <span className={styles.contextName}>{event.title}</span>
            </span>
