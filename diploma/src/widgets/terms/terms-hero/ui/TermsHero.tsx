  ...
  >
    <div className={styles.left}>
      <div className={styles.eyebrow}>
        ...
        />
        <span className={styles.eyebrowText}>Terms</span>
      </div>
      ...
      >
        These terms govern your use of ImpactFlow. By creating an account you
        agree to follow them — please read carefully.
      </motion.p>
    </div>
