...
export const useEventRoleMutations = ({
  eventId,
  setFormState,
  setPendingAction,
  setSelectedRole,
  ...
  const invalidate = () =>
    Promise.all([
      queryClient.invalidateQueries({
        queryKey: contextRoleKeys.entity("event", eventId, false),
      }),
      queryClient.invalidateQueries({
        queryKey: contextRoleKeys.entity("event", eventId, true),
      }),
      queryClient.invalidateQueries({
        queryKey: contextRoleKeys.templates("event"),
      }),
    ]);
